        ...
        <div className="grid gap-14 md:grid-cols-[1.05fr_0.95fr] md:items-start">
          <div className="sticky top-24">
            <div className="relative aspect-square overflow-hidden bg-[#efe9dc]">
              <Image src={product.image} alt={`${product.name}の商品写真`} fill priority className="object-contain p-10" />
            </div>
          ...
          <article>
            ...
            <p className="mt-10 leading-9 text-sumi/70">{product.story}</p>
            ...
            <section className="mt-14">
              <h2 className="font-serifjp text-2xl tracking-[0.12em]">味の特徴</h2>
            ...
            <section className="mt-14 border-l-2 border-[color:var(--accent)] bg-white/35 p-7" style={{ "--accent": product.accent } as CSSProperties}>
            ...
            <section className="mt-14">
              <h2 className="font-serifjp text-2xl tracking-[0.12em]">おすすめの食べ方</h2>
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                {product.ways.map((way) => (
                  <div key={way.title} className="border border-sumi/10 p-5">
            ...
            <section className="mt-14">
              <h2 className="font-serifjp text-2xl tracking-[0.12em]">商品情報</h2>
              <dl className="mt-6 divide-y divide-sumi/10 border-y border-sumi/10">
                {[
                  ["価格", product.price],
                  ["内容量", product.content],
            ...
            <section className="mt-14">
              ...
              <div className="mt-6 space-y-4">
                {faqs.map((faq) => (
                  <details key={faq.q} className="border border-sumi/10 p-5">
