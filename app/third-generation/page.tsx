...
const chapters = [
  ...
  {
    title: "山田もち店の未来",
    body: "私が目指しているのは、昔ながらの餅屋を守ることだけではありません。祖父や父が守ってきたものを大切にしながら、今の時代だからこそ届けられる価値を加え、飛騨高山を代表する餅ブランドへ育てていきたいと考えています。旅先で食べたお餅が、家に帰ってからも旅の思い出として残る。贈り物として届いたお餅が、人と人をつなぐきっかけになる。そんな存在になれるよう、これからも家族で餅づくりを続けていきます。"
  }
];
        ...
        <div className="grid gap-12 md:grid-cols-[0.9fr_1.1fr] md:items-end">
          <div>
            ...
            <p className="mt-8 max-w-2xl leading-9 text-sumi/70">
              なぜこの仕事を続けるのか。なぜ、餅づくりに人生をかけたいと思ったのか。山田もち店というブランドの背景にある物語です。
            </p>
          </div>
