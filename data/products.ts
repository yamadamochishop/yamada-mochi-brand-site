...
export const products: Product[] = [
  {
    ...
    accent: '#efe9dc',
    baseUrl: 'https://yamadamochi.thebase.in/items/42083183',
    price: '440円（税込）',
    content: '200g（4枚）',
    ingredients: 'もち米（岐阜県高山市産）',
    shelfLife: '製造日より8日',
    storage: '直射日光・高温多湿を避けて常温保存してください。',
    afterOpening: '開封後は密封して冷蔵し、早めにお召し上がりください。',
    frozenStorage: '長期保存する場合は1枚ずつ包んで冷凍してください。',
    allergy: 'なし',
  ...
  },
  {
    ...
    short: 'よもぎの香りを楽しむ、春の風味のお餅。',
    story:
      'よもぎの清らかな香りを、もち米の甘みと一緒に楽しむ草餅です。焼きはじめると、青くやさしい香りがふわりと立ち、どこか懐かしい春の風景を思わせます。自家栽培の「たかやまもち」が持つ素朴な甘みと、よもぎのほろ苦い余韻がほどよく重なり、あんこやきな粉とも相性のよい一枚。お茶の時間にも、贈り物にもおすすめです。',
    image: '/images/lineup-yomogi.jpg',
    imageAlt: 'よもぎを練り込んだ草切り餅',
    accent: '#8b9b67',
    baseUrl: 'https://yamadamochi.thebase.in/items/42083333',
    price: '440円（税込）',
    content: '200g（4枚）',
    ...
    recommendedFor: ['草餅が好きな方', '贈り物', 'お茶の時間', 'リピーター'],
    related: ['plain', 'sansyokumame', 'tamari'],
    seo: {
      title: '草餅｜飛騨高山の切り餅',
      description:
        'よもぎの香りと自家栽培もち米の甘みを楽しむ、山田もち店の草餅。春の風味を感じる切り餅です。',
    },
  },
  {
    slug: 'sansyokumame',
    ...
    accent: '#c49a62',
    baseUrl: 'https://yamadamochi.thebase.in/items/42083299',
    price: '440円（税込）',
    content: '200g（4枚）',
    ...
    seo: {
      title: '三色豆餅｜飛騨高山の切り餅',
      description:
        '黒豆・青大豆・大豆の食感と、たかやまもちのやさしい甘みを楽しむ山田もち店の三色豆餅。',
    },
  },
  {
    slug: 'kombu',
    ...
    story:
      '昆布の旨みとほどよい塩気を、自家栽培もち米の甘みの中に閉じ込めた昆布餅です。焼くと昆布の香りがふわりと立ち、噛むほどにじんわりと旨みが広がります。甘いお餅とは違い、食事の一品として楽しめるのも魅力。お雑煮や汁物にも合わせやすく、いつもの食卓に飛騨高山の朝市らしい素朴なおいしさを添えてくれます。',
    image: '/images/lineup-kombu.jpg',
    imageAlt: '昆布を練り込んだ昆布切り餅',
    accent: '#51594a',
    baseUrl: 'https://yamadamochi.thebase.in/items/42083403',
    price: '440円（税込）',
    content: '200g（4枚）',
    ...
    ownerRecommendation: '甘い味付けより、醤油を少しだけ。昆布の旨みともち米の甘みが引き立ちます。',
  ...
  },
  {
    ...
    accent: '#73512f',
    baseUrl: 'https://yamadamochi.thebase.in/items/42083448',
    price: '440円（税込）',
    content: '200g（4枚）',
    ingredients: 'もち米（岐阜県高山市産）、醤油',
    shelfLife: '製造日より8日',
    storage: '直射日光・高温多湿を避けて常温保存してください。',
    afterOpening: '開封後は密封して冷蔵し、早めにお召し上がりください。',
    frozenStorage: '長期保存する場合は1枚ずつ包んで冷凍してください。',
    ...
    seo: {
      title: 'たまり餅｜飛騨高山の切り餅',
      description:
        '焼けば醤油の香ばしさが広がる、山田もち店のたまり餅。通販でも人気の味付き切り餅です。',
    },
  },
  {
    slug: 'ebi',
    ...
    story:
      'アキアミ（えび）の旨みと黒ごまの香ばしさを重ねた、彩りのある切り餅です。焼くとえびの香りが立ち、黒ごまの風味とほどよい塩味があとからふわりと広がります。見た目にもやさしい紅色で、詰め合わせの中でも印象に残る一枚。お正月や贈り物はもちろん、普段の食卓にも少し華やかさを添えてくれるお餅です。',
    image: '/images/lineup-ebi.jpg',
    imageAlt: '黒ごまと海老を練り込んだ切り餅',
    accent: '#d47d63',
    baseUrl: 'https://yamadamochi.thebase.in/items/42083499',
    price: '440円（税込）',
    content: '200g（4枚）',
    ingredients: 'もち米（岐阜県高山市産）、干し海老、黒ごま、食塩',
    shelfLife: '製造日より8日',
    storage: '直射日光・高温多湿を避けて常温保存してください。',
    afterOpening: '開封後は密封して冷蔵し、早めにお召し上がりください。',
    frozenStorage: '長期保存する場合は1枚ずつ包んで冷凍してください。',
    allergy: '（原料の一部に、えび、ごまを含む）',
    shipping: '常温便 / 通常、ご注文から3〜5営業日以内に発送',
    traits: [
      { title: '香り', text: 'アキアミ（えび）と黒ごまの香ばしさ' },
    ...
    seo: {
      title: '黒ごま海老餅｜飛騨高山の切り餅',
      description:
        'アキアミ（えび）と黒ごまの香ばしさが重なる、彩りのある山田もち店の切り餅。ギフトにもおすすめです。',
    },
  },
];
